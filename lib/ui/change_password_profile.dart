...
class ChangePasswordState extends State<ChangePasswordHome> {
                                    ...
                                    child: new RaisedButton(
                                      onPressed: () {
                                        ...
                                        if (_confirmPass != _password) {
                                          _showSnackBar("Password Confirm Password not matching");
                                          return;
                                        }
                                        if(validCharacters.hasMatch(_password)) {
                                          ...
                                          _showSnackBar("Password missing charc");
                                        }
                                      },
  ...
  Future<Map<String, Object>> changePass() async {
    ...
    final response = await http.post(
        RestDatasource.CHANGE_PASSWORD_LIST_URL, body: j, headers: headers);
    progressDialog.hide();
  ...
  Future<bool> _onWillPop() async {
    return (await showDialog(
      ...
      builder: (context) => new AlertDialog(
        ...
        content: new Text('Do you want to exit fro set password'),
        actions: <Widget>[
          new FlatButton(
