...
import 'package:user/customview/cam/core/core.dart';
import 'package:user/customview/cam/darwin_camera.dart';
import 'package:user/customview/cam/theme/colors.dart';
import 'package:user/customview/cam/theme/dimensions.dart';


class MyCamApp extends StatefulWidget {
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<MyCamApp> {
