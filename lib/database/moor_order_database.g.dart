...
part of 'moor_order_database.dart';
...
class OrderMedicinesTableData extends DataClass
    implements Insertable<OrderMedicinesTableData> {
  final int id;
  final String name;
  final String image;
  final String dose;
  OrderMedicinesTableData(
      ...
      @required this.image,
      @required this.dose});
  factory OrderMedicinesTableData.fromData(
      Map<String, dynamic> data, GeneratedDatabase db,
      {String prefix}) {
    final effectivePrefix = prefix ?? '';
    final intType = db.typeSystem.forDartType<int>();
    final stringType = db.typeSystem.forDartType<String>();
    return OrderMedicinesTableData(
  ...
  factory OrderMedicinesTableData.fromJson(Map<String, dynamic> json,
  ...
  OrderMedicinesTableData copyWith(
  ...
  bool operator ==(other) =>
      ...
      (other is OrderMedicinesTableData &&
          other.id == this.id &&
...
class MedicinesTableCompanion extends UpdateCompanion<OrderMedicinesTableData> {
  final Value<int> id;
...
class $MedicinesTableTable extends OrderMedicinesTable
    with TableInfo<$MedicinesTableTable, OrderMedicinesTableData> {
  ...
  @override
  OrderMedicinesTableData map(Map<String, dynamic> data, {String tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : null;
    return OrderMedicinesTableData.fromData(data, _db, prefix: effectivePrefix);
  }
